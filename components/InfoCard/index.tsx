...
function InfoCard({
  ...
  return (
    <Link href={collection ? `/tracks/${track.slug}` : `/playlists/${playlist.id}`}>
      <div className="px-[10px] py-[10px] cursor-pointer transition-all duration-300 ease-in-out bg-transparent hover:bg-sidebarMenuHoverBg inline-block rounded-[14px] max-md:w-[172px] w-[223px] xl:w-[341px] max-sm:w-auto max-w-full">
        ...
        <div className="pt-2">
          <div className="text-whiteDisabled text-xs max-md:text-[8px] xl:text-[14px] font-normal">
        ...
        <div className="text-white text-[20px] max-md:text-[12px] xl:text-[22px] text-base">
        ...
        <div className="text-whiteDisabled text-xs max-md:text-[12px] xl:text-[22px] font-normal">
          <Link
        ...
        <div className="flex flex-row items-center pt-1 text-sm max-md:text-[12px] xl:text-[16px] space-x-[9px]">
          <Image
            src={
              !collection
        ...
        {!collection && (
          <div className="pt-2">
            <div className="text-whiteDisabled text-[15px] text-xs max-md:text-[8px] xl:text-[14px]">
