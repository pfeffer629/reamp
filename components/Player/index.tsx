...
export default function Player() {
  ...
  return (
    <>
      ...
      <div className="max-sm:block hidden fixed max-sm:min-w-auto min-w-[1280px] bg-sidebarBg h-[80px] w-full bottom-0 flex justify-center items-center px-[22px] font-Gilroy border-t border-darkLine">
