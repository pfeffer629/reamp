...
export default function Player() {
  ...
  return (
    <>
      ...
      <div className="z-[4] max-sm:hidden fixed max-sm:w-0 bg-sidebarBg h-[80px] w-full bottom-0 flex justify-center items-center px-[22px] font-Gilroy border-t border-darkLine">
